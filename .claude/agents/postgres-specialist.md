...
./test-local.ps1   # spins up pinned postgres:18.4-alpine3.24 on 127.0.0.1:5533 as gt-test-pg
...
docker run --name guardian-pg `
  ...
  -d postgres:18.4-alpine3.24@sha256:9a8afca54e7861fd90fab5fdf4c42477a6b1cb7d293595148e674e0a3181de15
