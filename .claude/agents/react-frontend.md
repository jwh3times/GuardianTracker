...
frontend/src/
  ...
  data/                         ← ADR 0020 data-access modules, one per domain resource. A module
    ...
    rolltargets.ts                ← Roll targets (slice 5b, behind the `god-roll` flag), landed after
                                   ...
                                   unmatched target's optional backend-selected `bestCopy` and
                                   `matchedPerks` evidence), and
  ...
  features/                    ← Feature slices; each owns its pages, feature-only components, helpers,
    ...
    rolltargets/               ← `/rolls`, behind the `god-roll` flag (slice 5b). RollTargets.tsx (the
                                   ...
                                   copy as "Your best copy has X of Y target perks" and highlights its
