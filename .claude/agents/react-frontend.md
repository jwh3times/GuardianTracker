...
They expose the TypeScript 7 adoption backlog without blocking CI.
...
suppression policy. `npm run type-check` (`tsc --noEmit`) remains the type gate,
and Prettier remains the formatter.
