...
convenience. Replace all placeholder values before deploying:
...
The two runtime images and the frontend Node builder are also pinned to
multi-platform OCI index digests in their Dockerfiles. Use the
drift-verification procedure in `SETUP.md` when refreshing those pins.
