...
backend/api-service/
  ...
  services/collections/types.go        ← Collections wire shapes (CategorySummary, DestinyItem) + the
                                           ...
                                           service.go
  services/characters/service.go       ← Character fetching; membershipstate-fenced InvalidateCache
                                           method (ADR 0018) advances that membership's generation and
                                           evicts its cache entry in one transition
