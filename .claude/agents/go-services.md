...
| Method                                | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GetCollectiblesByItemHashes(hashes)` | Every collectible def keyed by itemHash (`map[uint32][]CollectibleDefinition`); multiplicity is required for the wishlist acquisition-source union                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `GetAcquisitionRows(hashes)`          | Item definitions AND their linked collectibles for the requested hashes, read under ONE lock so a manifest swap cannot land between the two queries. Empty request touches no database. Backs `items.Lookup`; `GetItemView`/`ItemView` were deleted with it — the item-detail wire is now built from `items.AcquisitionFacts`, so armor `itemType` is slot-specific rather than a generic "Armor"                                                                                                                                                                                                                                                                                           |
