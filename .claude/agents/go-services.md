...
backend/api-service/
  ...
  api/handlers/wishlist.go             ← Wishlist CRUD + bulk delete/set_priority: binding, id parsing,
                                           ...
                                           serialization only — delegates persistence, mutation validation,
                                           and item-existence rules to *wishlist.Entries; still enriches
                                           responses itself with manifest defs, every collectible-derived
                                           acquisition source, and all-rotating-vendor availability
  ...
  services/wishlist/entries.go         ← Entries: the reusable wish list core (List, ListItemHashes, Add,
                                           ...
                                           the write instead of persisting unvalidated. Constructed before
                                           Weekly; the complete handler-facing wishlist.Service (B5) is
                                           not yet built
