/* ============================================================
   GUARDIAN TRACKER — MOCK DATA
   Realistic Destiny-flavored content. Item icons are stylized
   placeholders (faceted rarity tiles) — no external assets.
   Exposed on window.GT.
   ============================================================ */
(function () {
  ...
  // ---------- WEAPON / ITEM GLYPHS (simple type letters) ----------
  const TYPE_GLYPH = {
    "Auto Rifle": "AR", "Hand Cannon": "HC", "Pulse Rifle": "PR", "Scout Rifle": "SC",
    "Fusion Rifle": "FR", "Sniper Rifle": "SN", "Shotgun": "SG", "Sidearm": "SD",
    "Submachine Gun": "SMG", "Bow": "BOW", "Rocket Launcher": "RL", "Grenade Launcher": "GL",
    "Sword": "SWD", "Glaive": "GLV", "Machine Gun": "MG", "Linear Fusion": "LFR", "Trace Rifle": "TR",
    "Helmet": "HEL", "Gauntlets": "ARM", "Chest Armor": "CHS", "Leg Armor": "LEG", "Class Item": "CLS",
    "Ghost Shell": "GHO", "Sparrow": "SPR", "Ship": "SHP", "Shader": "SHD", "Emblem": "EMB", "Emote": "EMT",
  };
  ...
  const hero = [
    { name: "Vex Mythoclast", type: "Fusion Rifle", slot: "Power", rarity: "exotic", diff: "challenging",
      ...
      hue: 88, desc: "A weapon born of the Vault, its trigger pulses with the rhythm of the Vex collective consciousness.",
    ...
    { name: "Fatebringer", type: "Hand Cannon", slot: "Kinetic", rarity: "legendary", diff: "moderate",
      ...
      hue: 305, desc: "Time is a flat circle, and the Templar dies on every loop. So do you, occasionally.",
    ...
    { name: "Eyasluna", type: "Hand Cannon", slot: "Kinetic", rarity: "legendary", diff: "moderate",
      ...
      hue: 305, desc: "A masterwork of Dead Orbit engineering, refit for the Crucible's cruelest arenas.",
    ...
    { name: "Hawkmoon", type: "Hand Cannon", slot: "Kinetic", rarity: "exotic", diff: "moderate",
      ...
      hue: 88, desc: "Seven bullets, and the eighth is luck. The Paracausal stacks remember every kill.",
    ...
    { name: "Found Verdict", type: "Pulse Rifle", slot: "Energy", rarity: "legendary", diff: "easy",
      ...
      hue: 305, desc: "The Vault always closes. The verdict, once found, is rarely overturned.",
    ...
    { name: "Loaded Question", type: "Fusion Rifle", slot: "Energy", rarity: "legendary", diff: "moderate",
      ...
      hue: 305, desc: "The only stupid question is the one that doesn't overload the chamber.",
  ...
  let _id = 0;
  const nid = () => "i" + (++_id);
  function pick(a, seed) { return a[Math.abs(Math.floor(Math.sin(seed) * 1e4)) % a.length]; }

  function makeItem(name, i, forceRarity) {
    const t = pick(TYPES, i * 1.7 + 3);
    const src = pick(SOURCES, i * 2.3 + 1);
    const rarity = forceRarity || (i % 9 === 0 ? "exotic" : i % 3 === 0 ? "legendary" : i % 5 === 0 ? "rare" : "legendary");
    ...
    return {
      ...
      obtainable, collected, hue: rarity === "exotic" ? 88 : rarity === "rare" ? 240 : 305,
  ...
  const items = [];
  hero.forEach((h, i) => items.push({ id: nid(), obtainable: true, ...h }));
  NAMES.forEach((n, i) => items.push(makeItem(n, i)));
  // pad cosmetics
  ["Iron Companionship","Star-Spangled","Notorious Gambler","Solstice Glow","Twilight Gleam","New Pacific"]
    .forEach((n, i) => items.push({ ...makeItem(n, i + 40, "legendary"), type: pick(["Shader","Ghost Shell","Sparrow","Ship","Emblem"], i), slot: "Cosmetic" }));
  ...
  // ---------- WISHLIST ----------
  const wishlist = [
    { id: "wl1", name: "Fatebringer", type: "Hand Cannon", rarity: "legendary", priority: "urgent",
      avail: { now: true, where: "Vault of Glass" }, notes: "Want Explosive Payload + Firefly roll", added: "3d ago" },
    { id: "wl2", name: "Vex Mythoclast", type: "Fusion Rifle", rarity: "exotic", priority: "high",
      avail: { now: true, where: "Vault of Glass" }, notes: "Last raid exotic I need for the seal.", added: "1w ago" },
    { id: "wl3", name: "Hawkmoon", type: "Hand Cannon", rarity: "exotic", priority: "high",
      avail: { now: true, where: "Xûr · weekend" }, notes: "", added: "5d ago" },
    { id: "wl4", name: "Eyasluna", type: "Hand Cannon", rarity: "legendary", priority: "medium",
      avail: { now: true, where: "Trials of Osiris" }, notes: "Headstone + Snapshot for PvP.", added: "2w ago" },
    { id: "wl5", name: "Apex Predator", type: "Rocket Launcher", rarity: "legendary", priority: "medium",
      avail: { now: false, where: "Last Wish raid" }, notes: "Bait and Switch craftable.", added: "2w ago" },
    { id: "wl6", name: "Doom of Chelchis", type: "Scout Rifle", rarity: "legendary", priority: "medium",
      avail: { now: false, where: "King's Fall raid" }, notes: "", added: "3w ago" },
    { id: "wl7", name: "The Palindrome", type: "Hand Cannon", rarity: "legendary", priority: "low",
      avail: { now: false, where: "Competitive Crucible" }, notes: "", added: "1mo ago" },
  ];
  ...
  window.GT = {
    RARITIES, DIFFS, TYPE_GLYPH, characters, items, tree, weekly, wishlist,
    catalysts, crafting, seals, summary,
    label: {
      rarity: { exotic: "Exotic", legendary: "Legendary", rare: "Rare", uncommon: "Uncommon", common: "Common" },
