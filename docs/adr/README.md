...
| [0014](./0014-own-manifest-derived-publication.md)               | Manifest-derived publication ownership         | Sequenced; fence landed in `v1.0.14`; Items, Records, Efficiency, and Collections adopted; Weekly continues                                                                          |
...
| [0016](./0016-own-acquisition-recommendation-outcomes.md)        | Acquisition recommendation outcomes            | Sequenced; backend ownership and Weekly recommender cutover implemented; C2/C3 remain                                                                                                |
| [0017](./0017-own-the-browser-session-projection.md)             | Browser session projection                     | Implemented in `v1.3.10`                                                                                                                                                             |
| [0018](./0018-own-complete-membership-collections.md)            | Complete membership collections                | Sequenced; analysis core (B2) landed; complete Service read path, availability join, and membership-pair authorization (B4) landed in `v1.3.28`; refresh publication fencing remains |
| [0019](./0019-own-wish-list-and-preferences.md)                  | Wish list and Preferences ownership            | Sequenced; Preferences backend slice landed in `v1.1.0`; Wish list Entries (B3) landed, complete Service (B5) remains                                                                |
