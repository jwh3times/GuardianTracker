...
| [0017](./0017-own-the-browser-session-projection.md)             | Browser session projection                     | Sequenced; state machine and browser adapters landed in `v1.3.3`; composition cutover remains |
