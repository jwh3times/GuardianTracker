# Guardian Tracker changelog: 0.x

These historical release entries are archived from the root changelog, with early four-part tags backfilled from their merge diffs. See [CHANGELOG.md](../../CHANGELOG.md) for current releases.
...
- The browser session lifecycle — starting the Bungie OAuth flow, turning a
  ...
  [ADR 0012](../adr/0012-session-issuance-owns-the-session-lifecycle.md) and
  `CONTEXT.md`.
...
- Updated `@types/node` from 26.1.0 to 26.1.1, `msw` from 2.14.6 to 2.15.0.

## [0.1.0.7] - 2026-07-07

### Changed

- Updated `@radix-ui/react-alert-dialog` from 1.1.18 to 1.1.19, `@radix-ui/react-avatar` from 1.2.1 to 1.2.2, `@radix-ui/react-dropdown-menu` from 2.1.19 to 2.1.20, `@radix-ui/react-form` from 0.1.11 to 0.1.12, `@radix-ui/react-navigation-menu` from 1.2.17 to 1.2.18, `@radix-ui/react-progress` from 1.1.11 to 1.1.12, `@radix-ui/react-select` from 2.3.2 to 2.3.3, `@radix-ui/react-switch` from 1.3.2 to 1.3.3, `@radix-ui/react-tabs` from 1.1.16 to 1.1.17, `@radix-ui/react-toast` from 1.2.18 to 1.2.19, `@radix-ui/react-tooltip` from 1.2.11 to 1.2.12, `typescript-eslint` from 8.62.1 to 8.63.0.

## [0.1.0.6] - 2026-07-06

### Changed

- Updated `react-hook-form` from 7.80.0 to 7.81.0, `@vitest/coverage-v8` from 4.1.9 to 4.1.10.

## [0.1.0.5] - 2026-07-06

### Changed

- Updated the API builder image from Go 1.25-alpine to 1.26-alpine.

## [0.1.0.4] - 2026-07-04

### Changed

- Added first-run guidance and explicit Dashboard and Cosmetics loading, error, and empty states.

## [0.1.0.3] - 2026-07-04

### Changed

- Added configurable API rate limits, request body limits, readiness checks, and streamed manifest downloads.

## [0.1.0.2] - 2026-07-04

### Changed

- Added an implementation-plan document for roadmap work.

## [0.1.0.1] - 2026-07-03

### Changed

- Added automatic merge version tagging and CI coverage checks.

[0.3.82]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.81...v0.3.82
[0.3.81]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.80...v0.3.81
[0.3.80]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.79...v0.3.80
[0.3.79]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.78...v0.3.79
[0.3.78]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.77...v0.3.78
[0.3.77]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.76...v0.3.77
[0.3.76]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.75...v0.3.76
[0.3.75]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.74...v0.3.75
[0.3.74]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.73...v0.3.74
[0.3.73]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.72...v0.3.73
[0.3.72]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.71...v0.3.72
[0.3.71]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.70...v0.3.71
[0.3.70]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.69...v0.3.70
[0.3.69]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.68...v0.3.69
[0.3.68]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.67...v0.3.68
[0.3.67]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.66...v0.3.67
[0.3.66]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.65...v0.3.66
[0.3.65]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.64...v0.3.65
[0.3.64]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.63...v0.3.64
[0.3.63]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.62...v0.3.63
[0.3.62]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.61...v0.3.62
[0.3.61]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.60...v0.3.61
[0.3.60]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.59...v0.3.60
[0.3.59]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.58...v0.3.59
[0.3.58]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.57...v0.3.58
[0.3.57]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.56...v0.3.57
[0.3.56]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.55...v0.3.56
[0.3.55]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.54...v0.3.55
[0.3.54]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.53...v0.3.54
[0.3.53]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.52...v0.3.53
[0.3.52]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.51...v0.3.52
[0.3.51]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.50...v0.3.51
[0.3.50]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.49...v0.3.50
[0.3.49]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.48...v0.3.49
[0.3.48]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.47...v0.3.48
[0.3.47]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.46...v0.3.47
[0.3.46]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.45...v0.3.46
[0.3.45]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.44...v0.3.45
[0.3.44]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.43...v0.3.44
[0.3.43]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.42...v0.3.43
[0.3.42]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.41...v0.3.42
[0.3.41]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.40...v0.3.41
[0.3.40]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.39...v0.3.40
[0.3.39]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.38...v0.3.39
[0.3.38]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.37...v0.3.38
[0.3.37]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.36...v0.3.37
[0.3.36]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.35...v0.3.36
[0.3.35]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.34...v0.3.35
[0.3.34]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.33...v0.3.34
[0.3.33]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.32...v0.3.33
[0.3.32]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.31...v0.3.32
[0.3.31]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.30...v0.3.31
[0.3.30]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.29...v0.3.30
[0.3.29]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.28...v0.3.29
[0.3.28]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.27...v0.3.28
[0.3.27]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.26...v0.3.27
[0.3.26]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.25...v0.3.26
[0.3.25]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.24...v0.3.25
[0.3.24]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.23...v0.3.24
[0.3.23]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.22...v0.3.23
[0.3.22]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.21...v0.3.22
[0.3.21]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.20...v0.3.21
[0.3.20]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.19...v0.3.20
[0.3.19]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.18...v0.3.19
[0.3.18]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.17...v0.3.18
[0.3.17]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.16...v0.3.17
[0.3.16]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.15...v0.3.16
[0.3.15]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.14...v0.3.15
[0.3.14]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.13...v0.3.14
[0.3.13]: https://github.com/jwh3times/GuardianTracker/compare/v0.3.12...v0.3.13
...
[0.1.0.8]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.8
[0.1.0.7]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.7
[0.1.0.6]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.6
[0.1.0.5]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.5
[0.1.0.4]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.4
[0.1.0.3]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.3
[0.1.0.2]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.2
[0.1.0.1]: https://github.com/jwh3times/GuardianTracker/releases/tag/v0.1.0.1
