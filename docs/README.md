...
| [AGENTS.md](../AGENTS.md) | AI coding agents | Tool-neutral operating context and repo rules |
| [CLAUDE.md](../CLAUDE.md) | Claude coding agents | Claude-specific operating context and workflow notes |
